...
namespace GHIElectronics.TinyCLR.Drivers.TowerPro.SG90 {
    public class SG90Controller {
        ...
        public SG90Controller(PwmController pwmController, PwmChannel pwnChannel) {
